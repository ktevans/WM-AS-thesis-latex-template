...
\thesisTitle{Kate's Fantastic Thesis}
...
\thesisAuthor[Kate Evans]{Kate Evans}
...
\thesisMonth{June}
\thesisYear{2026}
\thesisAdvisor{Professor David Armstrong} % Advisor name with title
...
\thesisDegreeOne{Master of Science in Physics, William \& Mary, 2021}
\thesisDegreeTwo{Bachelor of Science in Comprehensive Physics, University of Washington in Seattle, 2019}
\thesisDegreeThree{Bachelor of Arts in Latin, University of Washington in Seattle, 2019}
...
\thesisCommittee[Physics]{Professor David Armstrong}{William \& Mary}  % use {College of William \& Mary} -- Shanhe
\thesisCommittee[Physics]{Professor Saskia Mordijck}{William \& Mary}
\thesisCommittee[Physics]{Professor Todd Averett}{William \& Mary}
\thesisCommittee[another]{Professor D}{William \& Mary}
\thesisCommittee[Physics]{Arun Tadepalli}{Thomas Jefferson National Accelerator Facility}
...
\thesisDedication{I would like to dedicate this dissertation to myself.}
